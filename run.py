...
def get_sales_data():
    ...
    while True:
        ...
        print("data should be six numbers, seperated by commmas.")
...
def validate_data(values):
    ...
    try:
        ...
        if len(values) != 6:
            raise ValueError(
                f"Exactly 6 values requred, you provied {len(values)}"
            )
...
def get_last_5_entries_sales():
    """
    Collect columns of data from sales worksheet, collectiing last 5 entries
    for each sandwich and returnds the data as a list of lists
    """
